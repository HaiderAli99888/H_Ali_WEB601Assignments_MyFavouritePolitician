...
export class ContentListComponent implements OnInit {
  contentArray: Content[] = [
    ...
    { id: 3, title: 'Narender Modi', description: 'Narendra Damodardas Modi; born 17 September 1950 is an Indian politician who has served as the 14th prime minister of India since May 2014.', creator: 'Haider Ali', imgURL: '', type: 'Politician', tags: ['India', 'Delhi'] },
